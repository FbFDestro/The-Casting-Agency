...
'''
    !!NOTE
    The following code was mainly developed by
    Udacity during a FullStack Course.
...
def check_permissions(permission, payload):
    ...
    if permission not in payload['permissions']:
        ...
        # changes error code from 403 to 401 due to postman tests
    return True
    ...
    if rsa_key:
        try:
            ...
            raise AuthError({
                'code': 'invalid_claims',
                'description':
                'Incorrect claims. Please, check the audience and issue.'
            }, 401)
        except Exception:
            raise AuthError({
                'code': 'invalid_header',
